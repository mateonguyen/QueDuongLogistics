...
namespace Backend.Migrations
{
    ...
    [Migration("20231222152254_008_Modified_Transaction_ENtity")]
    partial class _008_Modified_Transaction_ENtity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Backend.Entities.TransactionDetail", b =>
                {
                    ...
                    b.Property<int>("ContType")
                        .HasColumnType("int");

                    b.Property<int>("DeliveredPlaceId")
                        .HasMaxLength(150)
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Backend.Entities.TransactionDetail", b =>
                {
                    b.HasOne("Backend.Entities.Location", "DeliveredPlace")
                        .WithMany()
                        .HasForeignKey("DeliveredPlaceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Backend.Entities.Transaction", "Transaction")
                        .WithMany("TransactionDetails")
                        .HasForeignKey("TransactionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("DeliveredPlace");
